...
class Person(models.Model):
    ...
    person_latitude = models.DecimalField(max_digits=10, decimal_places=7, null=True, blank=True,
                                          default='')  # Возможно надо будет добавить цифр, если будут ошибки поиска координат
    person_longtitude = models.DecimalField(max_digits=10, decimal_places=7, null=True, blank=True,
                                            default='')  # Возможно надо будет добавить цифр, если будут ошибки поиска координат
...
class LectureCycleProject(models.Model):
    ...
    def __str__(self):
        return 'Проект - {} Курс лекций - {}'.format(self.lcp_projectId.project_name,
                                                     self.lcp_lectureCycleId.lc_name)  # Формат вывода, возможно, стоит изменить
...
class LectureHall(models.Model):
    ...
    lh_latitude = models.DecimalField(max_digits=10, decimal_places=7, null=True, blank=True,
                                      default='')  # Возможно надо будет добавить цифр, если будут ошибки поиска координат
    lh_longtitude = models.DecimalField(max_digits=10, decimal_places=7, null=True, blank=True,
                                        default='')  # Возможно надо будет добавить цифр, если будут ошибки поиска координат
