        ...
        <>
            ...
            <div className="chooseRole__steps">
                <div className="chooseRole__steps__text-wrapper">
                    <h2 style={{color: isLecturerStep1 || isCustomerStep1 ? "var(--main-blue)" : "var(--add-darkGrey)"}}>Шаг 1</h2>
                    <h2 style={{color: isLecturerStep2 || isCustomerStep2 ? "var(--main-blue)" : "var(--add-darkGrey)"}}>Шаг 2</h2>
                    <h2 style={{color: isLecturerStep3 || isCustomerStep3 ? "var(--main-blue)" : "var(--add-darkGrey)"}}>Шаг 3</h2>
                    <h2 style={{color: isLecturerStep4 || isCustomerStep4 ? "var(--main-blue)" : "var(--add-darkGrey)"}}>Шаг 4</h2>
                </div>
                <div className="chooseRole__steps__bar">
                    <div className="chooseRole__steps__bar-current"
                         style={{marginLeft: isLecturerStep2 || isCustomerStep2 ? "25%" : "" }}></div>
                </div>
            </div>

            <div className="chooseRole__content-wrapper">
                <div className="chooseRole__role"
                     style={{display: isLecturerStep2 || isLecturerStep3 || isLecturerStep4 || isCustomerStep2 || isCustomerStep3 || isCustomerStep4 ? "none" : "block" }}>
